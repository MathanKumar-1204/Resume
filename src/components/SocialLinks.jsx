...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mathan-kumar-055768246/",
    color: "#0A66C2",
  ...
  // },
  {
    ...
    subText: "@Sparkathon",
    icon: Youtube,
    url: "https://www.youtube.com/@Sparkathon-b7u",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@MathanKumar-1204",
    icon: Github,
    url: "https://github.com/MathanKumar-1204",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  const [ youtube, github, tiktok] = otherLinks;
